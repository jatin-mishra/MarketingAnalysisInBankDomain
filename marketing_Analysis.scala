...
Object marketing_Analysis{
   def main(args:Array[String]){
      ...
      val spark = SparkSession.builder.appName("marketing_Analysis").getOrCreate()
      
      val bank_people_data = spark.read.option("multiline","true").json("/user/jatinmishra2k99_gmail/bank_edited.json");
